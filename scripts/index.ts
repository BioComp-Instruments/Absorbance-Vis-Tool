...
function initSvg(svgInfo: SvgInfo) {
...
function initCsvManager(svgInfo: SvgInfo) {
...
function displayData(csvDataArray: string[][], svgInfo: SvgInfo) {
  ...
  const xAxis = d3
    ...
    .domain([0, d3.max(xData) as number]);
